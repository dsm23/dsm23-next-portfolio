...
const Divisor: FunctionComponent<Props> = (props) => {
  ...
  let leftCurve = useRef<SVGAnimateElement>(null);
  let rightCurve = useRef<SVGAnimateElement>(null);
  let leftBall = useRef<SVGAnimateMotionElement>(null);
  let rightBall = useRef<SVGAnimateMotionElement>(null);
  ...
  useEffect(() => {
    ...
    if (animationContainer.current instanceof SVGSVGElement) {
  ...
  return (
    <svg
      ...
      fill="none"
      viewBox="0 0 260 50"
      className="w-full text-sky-200 lg:px-28 print:hidden"
      stroke="currentColor"
    >
      <path
        strokeDasharray="134"
