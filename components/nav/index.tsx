  ...
  return (
    <div className={styles.container} ref={container} {...props}>
      ...
      >
        ...
        <span className="ml-4 hidden text-xl font-bold tracking-wide text-white md:inline lg:hidden print:inline">
          David Murdoch
        </span>
        <span className="ml-4 inline text-xl font-bold tracking-wide text-white md:hidden print:hidden">
          DSM
        </span>
      </Link>
